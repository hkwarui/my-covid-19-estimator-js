const UI = (estimate) => {
    ...
    document.getElementById('i-cases-for-ventilators-by-requested-time').textContent = estimate.impact.casesForVentilatorsByRequestedTime;
    ...
    document.getElementById('s-cases-for-ventilators-by-requested-time').textContent = estimate.severeImpact.casesForVentilatorsByRequestedTime;
